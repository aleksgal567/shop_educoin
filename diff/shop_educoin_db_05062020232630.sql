...
--
-- Хост: localhost
-- Время создания: Июн 05 2020 г., 22:26
...
INSERT INTO `orders` (`id`, `hidden`, `deleted`, `user_order`, `id_user`, `order_status`) VALUES
(1, 0, 0, '[{\"prod_id\":\"1\",\"count\":4},{\"prod_id\":\"2\",\"count\":4},{\"prod_id\":\"29\",\"count\":6},{\"prod_id\":\"6\",\"count\":1},{\"prod_id\":\"17\",\"count\":1}]', 1, 1),
(2, 0, 0, '[{\"prod_id\":\"4\",\"count\":2}]', 2, 1),
(3, 0, 0, '[{\"prod_id\":\"29\",\"count\":1}]', 1, 1);
...
INSERT INTO `users` (`id`, `hidden`, `deleted`, `login`, `phone`, `email`) VALUES
(1, 0, 0, 'ывм', '111', 'а'),
(2, 0, 0, 'в', '11', 'цывкамы');
